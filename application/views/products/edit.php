            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" 
                              rows="5"><?= set_value('description', $product->description) ?></textarea>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="price" name="price" 
                               value="<?= set_value('price', $product->price) ?>" step="0.01" required>
                    </div>
                    
                    <div class="col-md-6 mb-3">
                        <label for="sale_price" class="form-label">Sale Price</label>
                        <input type="number" class="form-control" id="sale_price" name="sale_price" 
                               value="<?= set_value('sale_price', $product->sale_price) ?>" step="0.01">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <?php if ($product->image): ?>
                        <div class="mb-2">
                            <img src="<?= base_url($product->image) ?>" alt="Current" 
                    ...
                    <?php if (!empty($gallery_images)): ?>
                        <div class="d-flex flex-wrap gap-2 mb-2">
                            <?php foreach ($gallery_images as $img): ?>
                                <img src="<?= base_url($img) ?>" class="img-thumbnail" 
