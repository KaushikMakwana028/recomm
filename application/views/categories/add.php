...
<div class="page-header">
    <div>
        <h1><i class="fas fa-plus me-2"></i>Add Category</h1>
...
<div class="row">
                ...
                <?= form_open_multipart('categories/add') ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" 
                                  rows="4"><?= set_value('description') ?></textarea>
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <span><i class="fas fa-info-circle me-2"></i>Tips</span>
            </div>
            <div class="card-body">
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <i class="fas fa-check-circle text-success me-2"></i>
                        Recommended image size: 500x500px
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-check-circle text-success me-2"></i>
